...
export default function Home() {
  ...
  const services = [
    {
      ...
      description:
        "Custom high-speed, SEO-optimized websites built with React, Next.js, and Tailwind CSS. We construct robust serverless backends and responsive frontends.",
      icon: Globe,
      features: [
        "Next.js & React",
    ...
    },
    {
      ...
      description:
        "Feature-rich, high-performance native iOS and Android apps powered by Flutter and React Native. Fully responsive design from screen to screen.",
      icon: Smartphone,
      features: [
    ...
    },
    {
      ...
      description:
        "Stunning brand identities, UI/UX layouts, and promotional graphics that communicate value instantly. We design with intent and pixel precision.",
      icon: Paintbrush,
      features: [
    ...
    },
    {
      title: "Video Editing",
      description:
        "Polished commercials, short-form vlogs, and custom kinetic animations designed to capture attention and boost search-engine retention.",
      icon: Film,
      features: [
        "Kinetic Typography",
        "Color Grading & SFX",
  ...
  const testimonials = [
    {
      quote:
        "capsloop completely transformed our digital presence. Our new Next.js site loads instantly, and we've seen a 40% bump in SEO-driven inquiries within weeks.",
    ...
    {
      quote:
        "Their attention to design details is remarkable. The digital brand design they made is extremely premium and has put us far ahead of our direct competitors.",
      author: "David Chen",
    ...
    {
      quote:
        "ZeTap has made networking incredibly easy. We ordered custom digital business cards for our whole team, and the user experience is flawless.",
    ...
    <div className="flex-1 bg-black text-white relative overflow-x-hidden selection:bg-orange-primary selection:text-black">
      ...
      <section className="relative min-h-[calc(100vh-80px)] flex items-center justify-center px-6 py-20 z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          >
            We architect high-conversion websites, feature-rich mobile apps,
            stunning graphics, and retention-maximizing videos optimized to
      ...
      <section id="services" className="py-32 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            >
              Accelerate your development cycle and visual branding with our
              premium, high-converting specialized services.
            </motion.p>
          </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-auto pt-6 border-t border-border-dark">
                    {service.features.map((feat, fIdx) => (
                      <div key={fIdx} className="flex items-center gap-2">
                        <CheckCircle2
                          size={14}
                          className="text-orange-primary flex-shrink-0"
                        />
      ...
      <section
        id="products"
        className="py-32 px-6 relative z-10 border-t border-border-dark bg-zinc-950/20"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-20">
            <motion.span
            ...
            <motion.p
              ...
              className="mt-4 text-text-muted text-base md:text-lg"
            >
              Explore our current production suite built internally to scale and
              automate professional connections and agency workspaces.
            </motion.p>
          </div>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="relative h-64 md:h-80 w-full overflow-hidden bg-black/60 flex items-center justify-center border-b border-border-dark">
                  ...
                  {/* Status pill */}
                  <span
                    className={`absolute top-6 right-6 text-xs font-bold font-mono px-3 py-1 rounded-full border ${
                ...
                <div className="p-8 md:p-10 flex flex-col flex-1">
                  ...
                  {/* Features List */}
                  <div className="mb-8">
                    <span className="text-xs uppercase font-mono text-white/50 tracking-wider block mb-3">
                      Key Highlights
                    </span>
                  ...
                  <div className="pt-6 border-t border-border-dark flex items-center justify-between">
                    <div className="flex gap-2">
                      {product.tags.map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="text-[10px] uppercase font-mono tracking-wider px-2 py-0.5 rounded border border-border-dark text-text-muted bg-white/[0.02]"
                        >
                          {tag}
                        </span>
                      ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="mt-6 text-text-muted leading-relaxed text-base md:text-lg">
                At capsloop, we align custom programming with elite UI/UX
                aesthetics and data-centric SEO architectures. We believe a
                digital presence should not just exist, it must excel and
                convert.
              </p>
              <p className="mt-4 text-text-muted leading-relaxed text-sm">
                Our collaborative workflow acts as a seamless extension of your
                marketing, development, and branding teams. From deep-dive web
                refactors to engaging post-production video runs, our work is
                defined by strict standards, responsive execution, and extreme
                performance.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-text-muted">
                      High performance code, zero compromises.
                    </span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-text-muted">
                      Built for search visibility and metrics.
                    </span>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex flex-col gap-6 relative z-10">
                ...
                <blockquote className="text-xl italic leading-relaxed text-white">
                  &ldquo;A clean codebase behaves like gravity; it naturally
                  attracts speed, indexing efficiency, and long-term technical
                  value. We build every card and script to stand up to that
                  load.&rdquo;
                </blockquote>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <motion.p
              ...
              className="mt-4 text-text-muted text-base md:text-lg"
            >
              Hear from startup founders, product managers, and networking
              experts who scaled their projects with us.
            </motion.p>
          </div>
      ...
      <section
        id="contact"
        className="py-32 px-6 relative z-10 border-t border-border-dark"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10 items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-text-muted text-sm leading-relaxed">
                Connect with our team today. Whether you have a specific
                development outline, design requirements, or want to deploy
                ZeTap for your enterprise, we will get back to you with custom
                projections within 24 hours.
              </p>
              ...
              {contactSubmitted ? (
                ...
                >
                  ...
                  <p className="text-xs text-text-muted">
                    Our core developers are looping in. We will reach out
                    shortly.
                  </p>
                </motion.div>
              ) : (
                ...
                >
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-xs uppercase font-mono text-text-muted tracking-wider mb-1.5"
                    >
                      Your Name
                    </label>
                    <input
      ...
      <footer className="border-t border-border-dark bg-black py-20 relative z-10 text-sm">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                <div className="border border-dashed border-orange-primary/60 rounded px-2.5 py-0.5 bg-orange-primary/5">
                  <span className="text-[10px] text-orange-primary font-mono tracking-wider">
                    [ LOGO ]
                  </span>
                </div>
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Elite digital service agency looping design, programmatic
                performance, and SEO best-practices into scalable assets.
              </p>
            </div>

            {/* Services Links */}
            <div>
              <span className="font-bold text-xs uppercase font-mono text-white tracking-widest block mb-4">
                Services
              </span>
          ...
          <div className="pt-8 border-t border-border-dark flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-text-muted">
            <span>
              &copy; {new Date().getFullYear()} capsloop. All rights reserved.
            </span>
