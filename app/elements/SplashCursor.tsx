...
export default function SplashCursor({
  ...
  DENSITY_DISSIPATION = 1.2, // ↓ slower fade
  VELOCITY_DISSIPATION = 0.9, // ↓ smoother motion
  PRESSURE = 0.22, // ↑ thicker fluid pressure
  PRESSURE_ITERATIONS = 20,
  CURL = 1.5, // ↓ less turbulence
  SPLAT_RADIUS = 0.38, // ↑ thicker strokes
  SPLAT_FORCE = 6000,
  SHADING = true,
